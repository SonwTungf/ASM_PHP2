        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item {{ $page == 1 ? "disabled" : "" }}">
                    <a class="page-link" href="{{ $page > 1 ? url('products?page=' . ($page - 1)) : url('products?page=' . $page) }}" aria-label="Previous">
                ...
                <li class="page-item {{ $page == $totalPage ? "disabled" : "" }}">
                    <a class="page-link" href="{{ $page == $totalPage ? url('products?page=' . $page) : url('products?page=' . $page + 1) }}" aria-label="Next">
