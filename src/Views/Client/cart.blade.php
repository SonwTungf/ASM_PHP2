                            ...
                            @foreach ($cart as $item)
                                <tr>
                                    ...
                                    <td class="cart-controls">
                                        ...
                                        @endphp
                                        <a class="btn btn-danger" href="{{ $urlDec }}">Giảm</a>
                                        <span>{{ $item['quantity'] }}</span>
                                        <a class="btn btn-primary" href="{{ $urlInc }}">Tăng</a>
                                    </td>
                                    <td>
                                        {{ number_format($item['price_sale'] ?: $item['price_regular']) }}
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a onclick="return confirm('Bạn có chắc chắn muốn xóa không?')"
                                            href="{{ $urlRemove }}" class="btn btn-danger">Xóa</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
